                    ...
                    tiers: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          accuracy: { type: 'number', description: '0–1 rate; always pair with accuracy_n' },
                          accuracy_n: { type: 'integer', description: 'Denominator for accuracy' },
                          accuracy_suite: { type: 'string', description: 'Calibration/eval suite label' },
                          false_allows: { type: 'integer' },
                          false_allows_n: { type: 'integer', description: 'Denominator for false_allows' },
                          latency_typical: { type: 'string', description: 'Honest wall-clock band (not a hard SLO)' },
                          latency_median: { type: 'string', description: 'Legacy alias of latency_typical' },
